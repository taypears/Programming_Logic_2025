    ...
    class Program
{
    static void Main(string[] args)
    {
        ...
        Dog myDog2 = new SmallDog(); //object called myDog2 created from Dog class
        Dog myDog3 = new MediumDog(); //object called myDog3 created from Dog class
        Dog myDog4 = new ExtraLargeDog(); //object called myDog4 created from Dog class

        myDog.DogSize(); //calling method to get dog breed
        myDog2.DogSize(); //calling method to get dog breed
        myDog3.DogSize(); //calling method to get dog breed
        myDog4.DogSize(); //calling method to get dog breed
